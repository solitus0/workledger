...
- `sed -n '1,120p' specs/functional.md` reads a targeted section without loading full files.
...
Future CLI work around local worklogs, planning, status, or reconcile flows must use the supporting skill at `.agents/skills/worklog-orchestrator/SKILL.md`.
